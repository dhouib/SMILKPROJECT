...
public class readJson {
    ...
    private static void readFilesJson() throws Exception {
        File folder = new File("C:/Users/dhouib/Desktop/SMILK_project_devpt/RelationExtractionSMILK/src/main/resources/output_farhad/");
        ...
        for (int f = 0; f < listOfFiles.length; f++) {
            if (listOfFiles[f].isFile()) {
                ...
                try {
                    ...
                    //String text = (String) jsonObject.get("text");System.out.println("text: " + text);

                    JSONArray annotatedSpot = (JSONArray) jsonObject.get("annotatedSpot");
                    System.out.println("\nannotatedSpot:");
                    for (int i = 0; i <annotatedSpot.size(); i++) {
                        //  System.out.println("the "+ i+"element of the array: "+annotatedSpot.get(i));
                    ...
                    while (iterator.hasNext()) {
                        ...
                        //System.out.println("Key: " + key + "Value: " + value.getSpot());
                        list.add(value);
                    }
            ...
            if ((list.get(x).getType().equals("PRODUCT")) || (list.get(x).getType().equals("RANGE"))) {
                ...
                for (int j = y; j < list.size(); j++) {
                    if ((list.get(j).getType().equals("BRAND"))) {
                        ...
                        // System.out.println(list.get(x).getSpot() + " belongsToBrand " + list.get(j).getSpot())
                        //  System.out.println(list.get(j).getSpot());
                ...
                for (int j = y; j < list.size(); j++) {
                    if ((list.get(j).getType().equals("PRODUCT")) || (list.get(j).getType().equals("RANGE"))) {
                        ...
                        // System.out.println(list.get(j).getSpot() + " belongsToBrand " + list.get(x).getSpot());
                        Spot subjectSpot, objectSpot;
            ...
            if (list.get(x).getType().equals("BRAND")) {
                ...
                for (int j = y; j < list.size(); j++) {
                    if (list.get(j).getType().equals("DIVISION")) {
                        //System.out.println(list.get(x).getSpot() + " belongsToDivision " + list.get(j).getSpot());
                        Spot subjectSpot, objectSpot;
                        subjectSpot=list.get(x);
                        objectSpot=list.get(j);
                        SentenceRelation sentenceRelation=new SentenceRelation();
            ...
            if (list.get(x).getType().equals("DIVISION")) {
                ...
                for (int j = y; j < list.size(); j++) {
                    if (list.get(j).getType().equals("GROUP")) {
                       // System.out.println(list.get(x).getSpot() + " belongsToGroup " + list.get(j).getSpot());
                        Spot subjectSpot, objectSpot;
                        subjectSpot=list.get(x);
                        objectSpot=list.get(j);
                        SentenceRelation sentenceRelation=new SentenceRelation();
                ...
                for (int j = y; j < list.size(); j++) {
                    if (list.get(j).getType().equals("DIVISION")) {
                      //  System.out.println(list.get(j).getSpot() + " belongsToGroup " + list.get(x).getSpot());
                        Spot subjectSpot, objectSpot;
                        subjectSpot=list.get(j);
                        objectSpot=list.get(x);
                        SentenceRelation sentenceRelation=new SentenceRelation();
            ...
            if (list.get(x).getType().equals("PRODUCT")) {
                ...
                for (int j = y; j < list.size(); j++) {
                    if (list.get(j).getType().equals("RANGE")) {
                        //System.out.println(list.get(x).getSpot() + " belongsToProductOrRange " + list.get(j).getSpot());
                        Spot subjectSpot, objectSpot;
                        subjectSpot=list.get(x);
                        objectSpot=list.get(j);
                        SentenceRelation sentenceRelation=new SentenceRelation();
                ...
                for (int j = y; j < list.size(); j++) {
                    if (list.get(j).getType().equals("PRODUCT")) {
                       // System.out.println(list.get(j).getSpot() + " belongsToProductOrRange " + list.get(x).getSpot());
                        Spot subjectSpot, objectSpot;
                        subjectSpot=list.get(j);
                        objectSpot=list.get(x);
                        SentenceRelation sentenceRelation=new SentenceRelation();
