...
public class EvaluationMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Sentences sentences_manu = (Sentences) jaxbUnmarshaller.unmarshal(new File("src/resources/output/Evaluation/corpus_google_total.xml"));

           /* Sentences sentences = (Sentences) jaxbUnmarshaller.unmarshal(new File("src/resources/output/evaluation_loreal_test/annotation_automatique_loreal.xml"));
            Sentences sentences_manu = (Sentences) jaxbUnmarshaller.unmarshal(new File("src/resources/output/evaluation_loreal_test/manuel_annotation_test_corpus_part0.xml"));
            */
