package fr.inria.smilk.ws.relationextraction.lucene3;
...
public class LuceneTest{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            writer.addDocument(createDocument("Allure Homme","Allure Homme est un parfum masculin de Chanel, créé par Jacques Polge et sorti en 1999"));
